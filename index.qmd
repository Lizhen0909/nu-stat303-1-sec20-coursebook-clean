...
- **Python Refresher**: Review Python basics and data structures from STAT 201 in two unnumbered chapters. You can use your existing STAT 201 setup for this review. For additional practice, visit the [STAT 201 ebook](https://lizhen0909.github.io/Intro_to_programming_for_data_sci/).
- **Setting Up for Data Science (Chapters 1–3)**: Learn why different projects need separate Python environments and package dependencies, configure VS Code, and develop your Jupyter notebook workflow. Chapter 1 begins the new STAT 303-1 material.
- **Core Library Foundations (beginning with Chapter 4, Reading Data)**: Extend your Python programming skills with essential third-party libraries for data science.
