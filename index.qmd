...
- **Setting Up for Data Science (Chapters 1–3)**: Work in Jupyter notebooks inside VS Code, manage project environments and local data paths, and create HTML submissions with Quarto. Each chapter ends with a practice activity; the final setup assignment connects all three.
